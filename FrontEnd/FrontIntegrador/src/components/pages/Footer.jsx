    ...
    <footer style={{ position: 'fixed', bottom: '0px' }}>
      <Box display='flex' justifyContent='space-between' alignItems='center' backgroundColor={colors.principal} width="100vw" padding={isMobile ? "20px 30px" : "20px 50px"}>
        ...
        <Box display={isMobile ? 'none' : 'flex'} justifyContent='space-between' alignItems='center' gap={'30px'} >
          <Link href="#"><FacebookIcon fontSize='large' sx={{ color: colors.c4 }} /></Link>
          <Link href="#"><LinkedInIcon fontSize='large' sx={{ color: colors.c4 }} /></Link>
          <Link href="#"><TwitterIcon fontSize='large' sx={{ color: colors.c4 }} /></Link>
          <Link href="#"><InstagramIcon fontSize='large' sx={{ color: colors.c4 }} /></Link>
        </Box>
      </Box>
    </footer>
  )
