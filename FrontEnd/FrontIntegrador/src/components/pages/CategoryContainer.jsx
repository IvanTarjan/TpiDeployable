...
const CategoryContainer = ({cars}) => {
  ...
  return (
    <Box display={"flex"} flexDirection="column" margin={"15px 0px"} justifyContent="center" alignItems="center">
        ...
        <Box display={"grid"} gridTemplateColumns={{xs: "1fr", md: "1fr 1fr", lg:"1fr 1fr 1fr 1fr"}} flexDirection={{xs: "column", sm:"row"}} gap={"15px"} justifyContent="center" alignItems={'center'} width='100%' flexWrap={"wrap"}>
